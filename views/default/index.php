...
<main>
    <div class="container top">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <img src="img/header_bg.jpg" height="722" width="1200" class="img-responsive" alt="Image">
    ...
    <div class="container about_us">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <p class="h1"><span class="color_black">О</span> <span class="color_red">нас</span></p>
            <hr class="line">
            <div class="text">
...
<!--    </div>-->
    <div class="container bg_black our_cont">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <p class="h1">Наши <span class="color_red">контакты</span></p>
                <hr class="line">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <img src="img/karta.jpg" height="528" width="1200" class="img-responsive" alt="Image">
            </div>
        </div>
    </div>
